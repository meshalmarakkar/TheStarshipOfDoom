...
TheGame.loadState = function(){ 	
	TheGame.gameWidth = 800;
	TheGame.gameHeight = 600;
};
TheGame.loadState.prototype = {
	...
	preload: function(){
		...
		this.game.load.spritesheet('invaderHeavy', 'assets/invader132x32x4.png', 32, 32);
  	...
  	create: function(){
		...
		TheGame.eurecaClientSetup();
	},
	
	update: function(){
		if (TheGame.MultiplayerServerReady) {
			this.game.state.start("menuStateVar");
		}
	},
